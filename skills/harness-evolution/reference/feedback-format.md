...
**Suggested fix:** Add a decision branch in gcp-deploy SKILL.md: "If project has cloudbuild.yaml, deploy via trigger, not gcloud run deploy --source."
```

### Good friction report (missing context)

```markdown
## 2026-07-20 | codebase-setup
